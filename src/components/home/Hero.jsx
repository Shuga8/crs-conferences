  ...
  return (
    <>
      <section className="hero-section px-4 md:px-7">
        <div className="flex flex-col justify-center items-center w-full min-h-[600px] bg-white bg-opacity-10 gap-y-[2.5rem] backdrop-blur-sm">
          <Fade triggerOnce={true}>
            ...
            <p className="py-1 text-center text-base lg:text-xl leading-8 mb-0.5 font-semibold">
