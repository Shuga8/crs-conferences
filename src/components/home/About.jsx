    ...
    <>
      <section className="about-section py-1.5 md:py-2.5 xl:py-3.5 px-6 md:px-16 lg:px-28 xl:px-44 select-none">
        ...
        <p className="py-1 text-center text-sm leading-8 mb-0.5">
          ...
          nemo sed repellendus modi nisi explicabo. Suscipit inventore tempore
          doloremque eveniet dolor. Amet nulla perferendis eos, dicta architecto
          optio quo inventore itaque officiis nobis nihil, quidem illo quis
          voluptatem quod. Lorem ipsum dolor, sit amet consectetur adipisicing
          elit. Nostrum officia vero odio eos totam voluptatem delectus
          dignissimos molestias accusantium, tempora, quasi ut alias praesentium
          nam cumque! Ducimus eos odio hic minus asperiores distinctio
          consequatur!
        </p>
